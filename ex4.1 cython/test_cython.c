...
static const char __pyx_k_Created_on_Fri_Feb_25_13_18_43[] = "\nCreated on Fri Feb 25 13:18:43 2022\n\n@author: zzw\n";
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    "test_cython",
    __pyx_k_Created_on_Fri_Feb_25_13_18_43, /* m_doc */
  #if CYTHON_PEP489_MULTI_PHASE_INIT
    0, /* m_size */
  #else
    -1, /* m_size */
 ...
 * print ("Hello World")             # <<<<<<<<<<<<<<
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_kp_u_Hello_World); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 7, __pyx_L1_error)
...
if (!__Pyx_RefNanny) {
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("test_cython", __pyx_methods, __pyx_k_Created_on_Fri_Feb_25_13_18_43, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
